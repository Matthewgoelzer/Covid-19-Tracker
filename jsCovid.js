...
function usaCurrentData() {
    ...
    req.open("GET", "https://api.covidtracking.com/api/v1/us/current.json", false);
    req.send(null);
...
function usaCasesGraph() {
    ...
    let req = new XMLHttpRequest();
    req.open("GET", "https://api.covidtracking.com/api/v1/states/current.json", false);
    req.send(null);
...
function getJsonUsaDaily() {
    let req = new XMLHttpRequest();
    req.open("GET", "https://api.covidtracking.com/api/v1/us/daily.json", false);
    req.send(null);
...
function getJsonStateDaily(stateSelected) {
    let req = new XMLHttpRequest();
    req.open("GET", "https://api.covidtracking.com/api/v1/states/daily.json", false);
    req.send(null);
 ...
 function totalCases() {
     ...
     let req = new XMLHttpRequest();
     req.open("GET", "https://api.covidtracking.com/api/v1/us.json", false);
     req.send(null);
...
function displayStateData(stateSelected) {
    ...
    let req = new XMLHttpRequest();
    req.open("GET", "https://api.covidtracking.com/api/v1/states.json", false);
    req.send(null);
